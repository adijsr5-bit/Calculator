            ...
            >
              ...
              <div className="flex-1 p-4 overflow-y-auto space-y-4 text-xs">
                    ...
                    <div
                      className={`w-7 h-7 rounded-xl flex items-center justify-center text-xs font-bold shrink-0 ${
                        m.sender === "user"
                          ...
                          : "bg-indigo-100 dark:bg-indigo-950 text-[#6D5DF6]"
                      }`}
                    >
                      ...
                      {m.link && (
                        <div className="mt-2 pt-2 border-t border-slate-200/50 dark:border-slate-700/50">
                          <Link
                            href={m.link}
                            onClick={() => setIsOpen(false)}
                            className="inline-flex items-center gap-1 font-bold text-[#6D5DF6] hover:underline"
                          >
                            {m.linkText || "View Tool"} <ArrowRight className="w-3 h-3" />
                          </Link>
                        </div>
                      )}
                    </div>
                ...
                {isTyping && (
                  <div className="flex items-center gap-2 text-slate-400 italic text-[11px]">
                    <Bot className="w-3.5 h-3.5 animate-spin" /> ValuePilot AI is thinking...
                  </div>
                )}
              </div>

              {/* Quick Prompts */}
              <div className="p-3 bg-slate-50/80 dark:bg-slate-950/80 border-t border-slate-200 dark:border-slate-800 flex gap-2 overflow-x-auto no-scrollbar">
              ...
              <div className="p-3 border-t border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/50 flex items-center gap-2">
                <input
                  ...
                  aria-label="Ask financial question to AI Advisor"
