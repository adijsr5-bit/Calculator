...
export function CalculatorWrapper({
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
          ...
          if (target) {
            ...
            header.innerHTML = `
              ...
              <div style="text-align: right; font-size: 11px; color: #94A3B8;">
                ...
                <div>Source: <strong style="color: #A5B4FC;">ValuePilot (https://valuepilot.vercel.app)</strong></div>
              </div>
            `;
      ...
      pdf.text("Generated by ValuePilot | Source: ValuePilot (https://valuepilot.vercel.app) | 100% Client-Side Private Calculation", 10, 287);
  ...
  // Generate Schemas
  const calcSchema = generateCalculatorSchema(title, subtitle, `https://valuepilot.vercel.app/calculators/${id}`);
    ...
    <div className="pt-24 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-12 w-full max-w-full overflow-x-hidden">
      ...
      <div ref={printRef} className="printable-area space-y-4">
        ...
        <div className="hidden print:block text-center text-xs text-slate-500 pt-6 border-t border-slate-200 mt-6 font-semibold">
          Generated by ValuePilot | Source: ValuePilot (https://valuepilot.vercel.app)
        </div>
      </div>
